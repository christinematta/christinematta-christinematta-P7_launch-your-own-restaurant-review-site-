...
class Menu extends Component{
    ...
    showForm(event) {
        ...
        this.setState({
            showForm: !this.state.showForm // toggel the state for ShowForm
        });
    ...
    render(){
        ...
        <nav className="menu">
            <h1 style={{backgroundImage:'url('+this.props.logo+')' , backgroundSize:'100%'}} className="menu__logo">logo</h1>
